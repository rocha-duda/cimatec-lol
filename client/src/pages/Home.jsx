          ...
          {results.dados?.length > 0 ? (
            <ul className="champion-list">
              {results.dados.map((champ) => (
                <li key={`${champ.championId}-${champ.posicao}`} className="champion-item">
                  <button
                  ...
                  >
                    <img
                      src={`https://ddragon.leagueoflegends.com/cdn/14.8.1/img/champion/${formatChampionName(champ.nome)}.png`}
                      alt={champ.nome}
